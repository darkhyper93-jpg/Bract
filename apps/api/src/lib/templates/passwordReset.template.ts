export const passwordResetTemplate = (resetUrl: string): { html: string; text: string } => ({
  html: `<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8" />
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p class="expiry">Este enlace expira en 1 hora. Si no solicitaste esto, ignora este email — tu contraseña no cambiará.</p>
    </div>
    <div class="footer">
      <p class="footer-text">© ${new Date().getFullYear()} Bract. Por razones de seguridad, este enlace solo puede usarse una vez.</p>
    </div>
  </div>
</body>
</html>`,
  text: `Restablece tu contraseña\n\nRecibimos una solicitud para restablecer la contraseña de tu cuenta en Bract. Haz clic en el siguiente enlace para crear una nueva:\n\n${resetUrl}\n\nEste enlace expira en 1 hora. Si no solicitaste esto, ignora este email — tu contraseña no cambiará.\n\n© ${new Date().getFullYear()} Bract. Por razones de seguridad, este enlace solo puede usarse una vez.`,
});
