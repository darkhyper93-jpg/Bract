...
export const analyticsRepository = {
  async getOverview(): Promise<AnalyticsOverview> {
    ...
    const [
      ...
      // DECISIÓN: _count: true (no { id: true }) -> tipa el resultado como number directo; con { id: true } Prisma
      // devuelve una unión true | {...} que rompe en strict. orderBy es obligatorio a nivel de tipos en groupBy.
